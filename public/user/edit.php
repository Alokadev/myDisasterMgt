...
if(!isset($_GET['id'])) {
    redirect_to(url_to('/public/user/myreport.php'));
}   
$id = $_GET['id'];
...
if(is_post_request()) { 
    ...
    $_SESSION['message'] = "Report Edited  Successfully Please Wait Untill Approval";
    redirect_to(url_to('/public/user/view.php?id=' . $id));
    } else {
...
<form action="<?php echo url_to('/public/user/edit.php?id=' . $id); ?>" method="post" enctype="multipart/form-data">
