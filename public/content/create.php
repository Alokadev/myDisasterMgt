...
if(is_post_request()) {
    ...
    if($result === true) {
        ...
        $_SESSION['message'] = "Report Has Created";
        redirect_to(url_to('/public/content/view.php?id=' . $new_id));
    } else {
        $errors = $result;
    }
}
...
<form action="<?php echo url_to('/public/content/create.php'); ?>" method="post" enctype="multipart/form-data">

<dl>
<dt>User ID : </dt>
<dd><input type="text" id="Uid" value="1" name="Uid"></dd>
</dl>
...
<dl>
<dt>Latitute : </dt>
<dd><input type="text" id="lat" name="lat" value=""readonly></dd>
</dl>
